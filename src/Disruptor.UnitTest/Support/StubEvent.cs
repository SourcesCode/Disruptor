namespace Disruptor.UnitTest.Support
{
    ...
    {
        public static readonly IEventTranslatorTwoArg<StubEvent, int, string> Translator = new EventTranslatorTwoArg();
        public static readonly IEventFactory<StubEvent> EventFactory = new EventFactory();
