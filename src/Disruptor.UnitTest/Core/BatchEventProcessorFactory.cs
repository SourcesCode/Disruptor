...
namespace Disruptor.UnitTest.Core
{
    /// <summary>
    ...
    public static class BatchEventProcessorFactory
    {
        ...
        /// <returns></returns>
        public static BatchEventProcessor<T> Create<T>(
            ...
            where T : class
        {
            ...
            return Activator.CreateInstance(batchEventProcessorType, dataProviderProxy, sequenceBarrierProxy, eventHandlerProxy, batchStartAwareProxy) as BatchEventProcessor<T>;
        }
