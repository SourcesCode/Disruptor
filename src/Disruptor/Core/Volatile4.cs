...
namespace Disruptor.Core
{
    ...
    public class _Volatile
    {
        ...
        /// </summary>
        public class AtomicReference<T> where T : class //struct
        {
            private T _value;
        ...
        /// </summary>
        [StructLayout(LayoutKind.Explicit, Size = CacheLineSize * 2)]
        public class PaddedIntegerArray
        {
            [FieldOffset(CacheLineSize)]
            private int[] _array;
            ...
            /// </summary>
            /// <param name="length">Length of the array</param>
            public PaddedIntegerArray(int length)
            {
                if (length <= 0) throw new ArgumentOutOfRangeException("length");
            ...
            /// </summary>
            /// <param name="array"></param>
            public PaddedIntegerArray(int[] array)
            {
                if (array == null) throw new ArgumentNullException("array");
